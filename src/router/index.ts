...
const routes: Array<RouteRecordRaw> = [
  ...
  {
    path: "/postmessagePromise",
    name: "PostMessagePromise",
    component: () => import("@/pages/postmessage-promise/index.vue"),
    meta: {
      depth: 1,
    },
  },
  {
    path: "/postmessagePromise/inner",
    name: "InnerPostmessagePromise",
    component: () => import("@/pages/postmessage-promise/inner-page.vue"),
    meta: {
      depth: 2,
    },
  },
